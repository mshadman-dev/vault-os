...
/**
 * IncomeCard — summary metric card for income.
 *
 * Part of Row 2 (two-column grid alongside ExpenseCard).
 */
export function IncomeCard({ label, value, trend = 'neutral', trendLabel }: MetricCardProps) {
  const trendClass =
    trend === 'up'
      ? styles.trendUp
      : trend === 'down'
